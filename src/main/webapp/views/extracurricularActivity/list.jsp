...
<div class="container-fluid">
	...
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="extracurricularActivity/parent/list.do?parentsGroupId=${parentsGroup.id}"><spring:message code="parentsGroup.extracurricular" /></a></li>
	...
	<display:table pagesize="5" class="table table-striped table-bordered" name="activities"
		requestURI="extracurricularActivity/parent/list.do?parentsGroupId=${parentsGroupId}"
		id="rowActivies">
	
		<display:column titleKey="extracurrAct.title">
			<jstl:out value="${rowActivies.title}" />
		</display:column>
	
		<display:column titleKey="extracurrAct.description">
			<jstl:out value="${rowActivies.description}" />
		</display:column>
	
		<display:column titleKey="extracurrAct.edit">
			<a
				href="extracurricularActivity/parent/edit.do?extracurricularActId=${rowActivies.id}">
				<spring:message code="extracurrAct.edit" />
			</a>
		</display:column>
	...
	<security:authorize access="hasRole('PARENT')">
		<a
			href="extracurricularActivity/parent/create.do?parentsGroupId=${parentsGroupId}">
			<spring:message code="extracurrAct.create" />
		</a>
	</security:authorize>
