...
<div class="container-fluid">
	...
	<jstl:if test="${displayGroup}">
		...
		<ul class="nav nav-tabs">
			...
			<li class="active"><a href="schoolCalendar/parent/display.do?parentsGroupId=${parentsGroup.id}"><spring:message code="parentsGroup.calendar" /></a></li>
		...
		<br/>
		<br/>
		<jstl:if test="${noCalendar}">
			<p><spring:message code="schoolCalendar.noCalendar" /></p>
		</jstl:if>
		<p><a href="schoolCalendar/list.do"><spring:message code="schoolCalendar.link.schoolCalendar" /></a></p>
	</jstl:if>
	<jstl:if test="${!noCalendar}">
		<br/>
		<br/>
		<div style="text-align:center;">
			<img src="${schoolCalendar.image}" alt="${schoolCalendar.image}" width="100%" style="max-width: 700px;" />
		</div>
		<br/>
		<jstl:if test="${!displayGroup}">
